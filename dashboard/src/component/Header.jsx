                ...
                <nav>
                    <div className='flex justify-between items-center bg-light-800 text-dark px-6 py-4 border-b border-gray-300'>
                        ...
                        <div className='flex items-center'>
                            ...
                            <Link className='bg-slate-200 rounded-xl font-medium px-4 py-4 flex mr-4'>
                                <span className=''>
                            ...
                            <Link className='bg-slate-200 rounded-xl font-medium px-4 py-4 flex mr-6'>
                                <span className=''>
                            ...
                            <Link className='rounded-full flex w-13 border-1 border-gray-300 p-1 overflow-hidden'>
